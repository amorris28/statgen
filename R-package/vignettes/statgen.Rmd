...
grouped_annotations <- load_annotation(
  system.file("extdata", "grouped.annot", package = "statgen"),
  reference,
  has_header = TRUE,
  group_column = "group"
)
...
is_binary(annotations)
annotation_metadata(annotations)[!is_binary(annotations)]
```
