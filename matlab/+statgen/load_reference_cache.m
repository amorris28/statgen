...
%   panel = statgen.load_reference_cache(path, shards)
    ...
    for i = 1:numel(selected)
        ...
        sd   = shards_data(idx);
        chr_v = statgen.internal.ensure_cell_col(sd.chr);
        snp_v = statgen.internal.ensure_cell_col(sd.snp);
        a1_v  = statgen.internal.ensure_cell_col(sd.a1);
        a2_v  = statgen.internal.ensure_cell_col(sd.a2);
