...
### Added
- Added grouped binary annotation loading in Python, MATLAB/Octave, and R.
  `load_annotation(...)` now accepts `group_column` to create one binary
  annotation per distinct group value in a BED-like source column.
